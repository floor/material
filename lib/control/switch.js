...
var Switch = prime({
	...
	toggle: function() {
		if (!this.checked) {
			...
			this.knob.animate({'background-color': 'rgba(150,136,100,1)'}, {duration: ".2s", equation: 'ease-in'});
			this.control.animate({'background-color': 'rgba(150,136,100,.5)'}, {duration: ".2s", equation: 'ease-in'});
			
		} else {
			this.checked = false;

			this.knob.animate({'left': '-2px'}, {duration: ".1s", equation: 'ease-in'});
			this.knob.animate({'background-color': '#F1F1F1'}, {duration: ".2s", equation: 'ease-in'});
			this.control.animate({'background-color': '#221F1F'}, {duration: ".2s", equation: 'ease-in'});
		}
