...
var List = prime({
	...
	build: function(string) {
		...
		this.c.body.delegate('click', '.ui-item', function(event, item){ // a is the matching element
	...
	addItem: function(item, idx) {
		...
		console.log('this.c.body',this.content, this.c.body);

		var where = 'bottom';

		item.inject(this.c.body);

		console.log('item', item);

		//var html = document.createElement(info);
