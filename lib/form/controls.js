...
let ButtonControl = require('UI/Control/Button');
let ChoiceControl = require('UI/Control/Choice');
let StepsControl = require('UI/Control/Steps');
let DropdownControl = require('UI/Control/Dropdown');
let MultiControl = require('UI/Control/Multi');
let SelectControl = require('UI/Control/Select');
let CheckControl = require('UI/Control/Check');
